...
export default function Booking({ isLoggedIn }) {
  ...
  async function handleMount() {
    ...
    setSelectedMeetings(booking.meetings)
    const selectedTrip = await getTrip(booking.tripId)
    ...
    <div className="content">
      ...
      <div className="booking">
        ...
        <div className="booking-selectors content">
          ...
          <Button variant="contained" disabled={!valid} onClick={handleBooking}>Update Booking</Button>
        </div>
      </div>
    </div>
  )
